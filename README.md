...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-733b013-systems-infrastructure-and-operations`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-733b013-systems-infrastructure-and-operations --clone
cd dynamo-733b013-systems-infrastructure-and-operations
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-733b013-systems-infrastructure-and-operations --fill
```
